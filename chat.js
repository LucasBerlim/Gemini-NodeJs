...
const arquivos = await leArquivos(["jogos.txt", "Politicas.txt"]);
...
export async function executaChat(mensagem) {
  ...
  let prompt = mensagem + " talvez esse trecho te ajude a formular a resposta, mas só fale sobre os dados se o usuário perguntar sobre! " + doc.text;
